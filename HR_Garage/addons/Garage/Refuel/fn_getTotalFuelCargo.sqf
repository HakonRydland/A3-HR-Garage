...
{
    private "_vehData";
    for "_i" from 0 to 4 do { _vehData = (HR_Garage_Vehicles#_i) get _x; if (!isNil "_vehdata") exitWith {}; }; //find vehicles in categorys, typically cat 0 "cars"
    private _fuelData = _vehData#4#0;
    _totalFuelCargo = _totalFuelCargo + (if (HR_hasAce) then {
