/*
    ...
    Public: Yes
    Dependencies: HR_Garage_Vehicles

    Example: [_classes, ""] call HR_Garage_fnc_addVehiclesByClass;
...
private _cfg = configFile >> "CfgVehicles";
{
    ...
    private _source = [
        [_x] call HR_Garage_fnc_isAmmoSource
        ,[_x] call HR_Garage_fnc_isFuelSource
        ,[_x] call HR_Garage_fnc_isRepairSource
    ];
