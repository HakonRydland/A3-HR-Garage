/*
    ...
    Example: [_cargo, _vehicle] remoteExec ["HR_fnc_logistics_addWeaponAction", 0, _cargo];
*/
...
private _actionID = _vehicle addAction [
    _text,
    {
        ...
        } else {hint "Someone is already in the static"};
    },
    _cargo,
    5.5,
    true,
...
[_cargo] call HR_fnc_logistics_initMountedWeapon;
